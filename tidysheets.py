...
"""
Version 0.0.1
-- Cleans files by removing leading/trailing spaces and forces lowercasea in all cells.

USAGE
-- Run from CLI tidysheet.py along with any number of files. It will place cleaned version of those same files within a subfolder called cleaned files using the original file name.
